        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
                <td style="padding:24px 28px;">
                    <p style="margin:0 0 4px 0;font-family:Georgia,serif;font-size:11px;font-weight:700;color:#C8871F;letter-spacing:0.1em;text-transform:uppercase;">Confirmed Booking</p>
                    <p style="margin:0 0 20px 0;font-family:Georgia,serif;font-size:18px;font-weight:700;color:#1A1A1A;">{{ $serviceName }}</p>

                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="50%" style="padding-bottom:12px;font-family:Georgia,serif;font-size:13px;color:#777777;">📅 Date</td>
                        ...
                        <tr>
                            <td style="padding-bottom:12px;font-family:Georgia,serif;font-size:13px;color:#777777;">⏰ Time</td>
                            <td style="padding-bottom:12px;font-family:Georgia,serif;font-size:13px;font-weight:600;color:#1A1A1A;">{{ $booking->booking_time }}</td>
                        </tr>
                        <tr>
                            <td style="font-family:Georgia,serif;font-size:13px;color:#777777;">📋 Status</td>
                            <td style="font-family:Georgia,serif;font-size:13px;font-weight:700;color:#2B8B3D;">Confirmed</td>
                        </tr>
                    </table>
