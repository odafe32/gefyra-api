        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
                <td style="padding:24px 28px;">
                    <p style="margin:0 0 4px 0;font-family:'DM Sans',-apple-system,Arial,sans-serif;font-size:11px;font-weight:700;color:#C8871F;letter-spacing:0.1em;text-transform:uppercase;">Booking Reference</p>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="50%" style="padding-bottom:12px;font-family:'DM Sans',-apple-system,Arial,sans-serif;font-size:13px;color:#777777;">📅 Requested Date</td>
                        ...
                        <tr>
                            ...
                            <td style="font-family:'DM Sans',-apple-system,Arial,sans-serif;font-size:13px;font-weight:700;color:#CC3333;">Declined</td>
                        </tr>
                    </table>
